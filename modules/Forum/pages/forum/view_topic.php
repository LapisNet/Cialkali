...
foreach ($results->data as $n => $nValue) {
    ...
    $replies[] = [
        ...
        'last_seen_full' => date('Y/m/d', $post_creator->data()->last_online),
        ...
        'user_registered' => $language->get('admin', 'registered'),
        'user_registered_full' => date('Y/m/d', $post_creator->data()->joined),
